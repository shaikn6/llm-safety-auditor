...
class MockLLM:
    ...
    def __init__(
        self, global_seed: int = 42, failure_rate_override: float | None = None
    ):
    ...
    def _pick_unsafe_response(
        self, rng: random.Random, category: AttackCategory
    ) -> str:
    ...
    def complete(self, attack: AttackPrompt) -> LLMResponse:
        ...
        return LLMResponse(
            ...
            tokens_used=self._estimate_tokens(attack.template)
